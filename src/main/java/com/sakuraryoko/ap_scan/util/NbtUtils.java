...
public class NbtUtils
{
	...
	public static NbtCompound readNbtFromFile(@Nonnull File file, NbtSizeTracker tracker)
	{
		...
		{
			ApScan.LOGGER.warn("readNbtFromFile: Failed to read NBT data from file '{}' (failed to create the input stream)", file.getAbsolutePath());
			return null;
		}
		...
		if (nbt == null)
		{
			ApScan.LOGGER.warn("readNbtFromFile: Failed to read NBT data from file '{}'", file.getAbsolutePath());
		}
